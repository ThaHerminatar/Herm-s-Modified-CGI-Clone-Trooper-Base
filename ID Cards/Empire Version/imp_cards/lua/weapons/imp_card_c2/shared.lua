...
SWEP.PrintName				= "Empire Card (Level 2)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/imp_cards/c_imp_cl2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/imp_cards/w_imp_cl2.mdl" -- Weapon world model path
