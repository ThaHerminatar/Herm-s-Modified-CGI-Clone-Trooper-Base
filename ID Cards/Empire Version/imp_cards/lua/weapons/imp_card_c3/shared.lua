...
SWEP.PrintName				= "Empire Card (Level 3)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/imp_cards/c_imp_cl3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/imp_cards/w_imp_cl3.mdl" -- Weapon world model path
