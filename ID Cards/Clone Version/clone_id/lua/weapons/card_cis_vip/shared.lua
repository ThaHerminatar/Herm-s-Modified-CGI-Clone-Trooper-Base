...
SWEP.PrintName				= "CIS VIP Card"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/clone_card/c_clone_card_clcisvip.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/clone_card/w_clonecard_clcisvip.mdl" -- Weapon world model path
