...
SWEP.PrintName				= "CIS Trooper Card"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/clone_card/c_clone_card_clcistrp.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/clone_card/w_clonecard_clcistrp.mdl" -- Weapon world model path
