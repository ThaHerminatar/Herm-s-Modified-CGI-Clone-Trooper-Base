...
SWEP.PrintName				= "Republic Card"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/clone_card/c_clone_card_clrepublic.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/clone_card/w_clonecard_clrepublic.mdl" -- Weapon world model path
