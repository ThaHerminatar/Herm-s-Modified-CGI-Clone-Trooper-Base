...
SWEP.PrintName				= "Clone card (Level 1)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/clone_card/c_clone_card_cl1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/clone_card/w_clonecard_cl1.mdl" -- Weapon world model path
