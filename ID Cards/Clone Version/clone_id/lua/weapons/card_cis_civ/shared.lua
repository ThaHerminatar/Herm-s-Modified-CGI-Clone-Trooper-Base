...
SWEP.PrintName				= "CIS Civilian Card"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/herm_weapons/clone_card/c_clone_card_clcisciv.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/herm_weapons/clone_card/w_clonecard_clcisciv.mdl" -- Weapon world model path
